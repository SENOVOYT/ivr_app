                ...
                <x-table.row>
                    ...
                    <x-table.cell class="text-center">
                          ...
                          <div id="dropdownDotsHorizontal1" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                              ...
                              <a href="#" class=" flex items-left pl-4 py-2 text-sm font-medium text-red-600 border-t border-gray-200 rounded-b-lg bg-gray-50 dark:border-gray-600 hover:bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-red-500">

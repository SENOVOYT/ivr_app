                                ...
                                <div class=" flex items-end gap-1 ">
                                    <div wire:sortable.handle class=" mr-auto flex">
                                     ...
                                     <div class="   items-end gap-1  flex">
                                        ...
                                        <a wire:click="$emit('openModal','edit-category-livewire-component', {{ json_encode(["category" => $categories->id]) }})'" class=" text-gray-500 rounded cursor-pointer dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-600">

                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 fill-yellow-400 w-5 rounded-md " fill="currentColor"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg>
                                            </a>

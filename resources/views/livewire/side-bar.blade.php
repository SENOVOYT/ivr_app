...
<li>
    <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="{{ $side->id }}" data-collapse-toggle="{{ $side->id }}">
    ...
    <ul id="{{ $side->id }}" class="hidden py-2 space-y-2">
          <li>
